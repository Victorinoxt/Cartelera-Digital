...
class _MonitoringScreenState extends ConsumerState<MonitoringScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildContent(List<ContentModel> items) {
    ...
    return TabBarView(
      ...
      children: [
        ...
        // Items activos
        _buildItemList(filteredItems.where((item) => true).toList()), // Ajustar según tu lógica de estado
        // Items completados
        _buildItemList(filteredItems.where((item) => true).toList()), // Ajustar según tu lógica de estado
      ],
    );
  ...
  Widget _buildItemList(List<ContentModel> items) {
            ...
            itemBuilder: (context, index) {
              ...
              return Padding(
                ...
                child: MonitoringCard(
                  content: item,
                  onTap: () => _showMonitoringDetails(item),
                ),
              );
            },
          );
